...
tech:
  - label: Fournir les informations
    body: "Assure la maîtrise et améliore grandement la qualité."
  - label: Fournir les outils
    body: "Apporte du déterminisme, améliore la qualité."
  ...
  - label: Fournir un feedback autonome
    body: "Gain sur la qualité et la rapidité."
  - label: Automatiser la construction du contexte
    body: "Sinon les règles précédentes sont insoutenables."
guards:
